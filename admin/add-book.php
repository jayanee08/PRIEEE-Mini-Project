...
$price=$_POST['price'];
$stock=$_POST['stock'];
$sql="INSERT INTO  tblbooks(BookName,CatId,AuthorId,PubId,ISBNNumber,BookPrice,stock) VALUES(:bookname,:category,:author,:publication,:isbn,:price,:stock)";
...
<select class="form-control" name="publication" required="required">
...
<p class="help-block">An ISBN is an International Standard Book Number.ISBN Must be unique</p>
 ...
 <input class="form-control" type="text" name="stock" autocomplete="off"   required="required" />
 </div>
